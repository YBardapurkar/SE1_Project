...
public class RentalManagerActivity extends AppCompatActivity{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setTitle("Rental Manager : Car Details");
...
//                    Toast.makeText(com.se1.team3.campuscarrental.ViewCarDetailsActivity.this, "Reserved: " + generateReservationNumber(6), Toast.LENGTH_SHORT).show();
//                }
//            });
//
//            calculatePrice(car, days);
